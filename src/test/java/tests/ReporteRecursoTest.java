...
public class ReporteRecursoTest {
    ...
    public void CERecursos1Test() throws ExceptionServiciosReporte,SQLException, Exception{
        ...
        stmt.execute("INSERT INTO Recurso (id,recurso,disponible,clase_id ,cantidad)  VALUES(1, 'libro de economia 1',true, 2,1);");
        stmt.execute("INSERT INTO Recurso (id,recurso,disponible,clase_id ,cantidad)  VALUES(2, 'libro de economia 1',true, 2,1);");
        getConnection().close();
    ...
    public void CERecursos2Test() throws ExceptionServiciosReporte, SQLException, Exception{
        ...
        stmt.execute("INSERT INTO Recurso (id,recurso,disponible,clase_id ,cantidad)  VALUES(4, 'libro de economia 2',true, 2,11);");
        stmt.execute("INSERT INTO Recurso (id,recurso,disponible,clase_id ,cantidad)  VALUES(3, 'libro de economia 1',true, 1,10);");
